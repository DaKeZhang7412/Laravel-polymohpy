...
<html lang="en">
    ...
    @include('store.admin-layouts.header')

    <body>
    @include('store.admin-layouts.menu')

    @include('store.admin-layouts.search')

    @include('store.admin-layouts.sidebar')
    <!--main-container-part-->
    ...
    @include('store.admin-layouts.script')
    @include('store.admin-layouts.footer')
